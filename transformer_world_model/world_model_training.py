...
from networks import WorldModel, ActorCritic
...
def main(config=None, project="JAXUED_TEST"):
    ...
    def create_train_state(rng):
        ...
        world_model = WorldModel((5, 5, 3), config, dtype=jnp.bfloat16)
    ...
    def train_step(runner_state, _):
        ...
        def loss_fn(params):
            ...
            mode_accuracy = (pred_next_z_dist[:-1].mode() == z_dist.mode()[1:]).mean()
            conditioned_mode_accuracy = (pred_next_z_dist[:-1].mode() == z_dist.mode()[1:])[100:].mean()
    ...
    def eval(rng, train_state):
        ...
        def loss_fn(params):
            ...
            loss = l_recon + l_pred + l_dyn - config['entropy_coeff'] * entropy
            return loss, ((l_recon, l_pred, l_dyn, entropy), (mode_accuracy, conditioned_mode_accuracy))
        return loss_fn(train_state.params)
    ...
    def train_and_eval(runner_state, _):
        ...
        (eval_loss, (eval_losses, eval_accuracies)) = eval(_rng, train_state)
